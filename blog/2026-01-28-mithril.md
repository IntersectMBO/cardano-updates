...
This week, the Mithril team prepared the pre-release for the `2603.1-pre` distribution. This version introduces DMQ protocol support, preliminary support for decentralized configuration, implementation of Blockfrost API to fetch SPO pool tickers & names, and various bug fixes and improvements.
